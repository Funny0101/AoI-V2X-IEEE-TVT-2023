...
class Agent():
    ...
    def local_learn(self, global_loss, state, action, reward_t1, reward_t2, state_, terminal,
        ...
        if accumulate_actor_grad:
            # Only accumulate gradients, don't step optimizer or update targets
            self.actor.train()
    ...
    def update_local_critic_targets(self):
        tau = self.tau
    ...
    def update_shared_actor_target(self):
        tau = self.tau
