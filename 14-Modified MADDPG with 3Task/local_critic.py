...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, n_actions, gamma, C_fc1_dims, C_fc2_dims, A_fc1_dims,
        ...
        self.critic_task3 = CriticNetwork(beta, input_dims, C_fc1_dims, C_fc2_dims, n_agents,
                                          n_actions=n_actions, name='critic_task3', agent_label=agent_name)
        ...
        self.target_critic_task3 = CriticNetwork(beta, input_dims, C_fc1_dims, C_fc2_dims, n_agents,
                                                 n_actions=n_actions, name='target_critic_task3', agent_label=agent_name)
    ...
    def load_models(self):
        ...
        self.critic_task3.load_checkpoint()
        self.target_critic_task1.load_checkpoint()
        self.target_critic_task2.load_checkpoint()
        self.target_critic_task3.load_checkpoint()

    def local_learn(self, global_loss, state, action, reward_t1, reward_t2, reward_t3, state_, terminal):
        ...
        # --- Task 3 critic update ---
        critic_value_task3_ = self.target_critic_task3.forward(states_, target_actions)
        critic_value_task3 = self.critic_task3.forward(states, actions)

        critic_value_task3_[done] = 0.0
        critic_value_task3_ = critic_value_task3_.view(-1)

        target_task3 = rewards_t3 + self.gamma*critic_value_task3_
        target_task3 = target_task3.view(self.batch_size, 1)

        self.critic_task3.train()
        self.critic_task3.optimizer.zero_grad()
        critic_loss_task3 = F.mse_loss(target_task3, critic_value_task3)
        critic_loss_task3.backward()
        self.critic_task3.optimizer.step()
        self.critic_task3.eval()

        # --- Actor update: -critic_task1 - critic_task2 - critic_task3 + global_loss*2 ---
        ...
        actor_loss = -self.critic_task1.forward(states, self.actor.forward(states)) \
                     ...
                     -self.critic_task3.forward(states, self.actor.forward(states))
    ...
    def update_network_parameters(self, tau=None):
        ...
        critic_params_task3 = self.critic_task3.named_parameters()
        ...
        target_critic_params_task3 = self.target_critic_task3.named_parameters()

        critic_state_dict_task1 = dict(critic_params_task1)
        critic_state_dict_task2 = dict(critic_params_task2)
        critic_state_dict_task3 = dict(critic_params_task3)
        ...
        target_critic_state_dict_task3 = dict(target_critic_params_task3)
        ...
        for name in critic_state_dict_task3:
            critic_state_dict_task3[name] = tau*critic_state_dict_task3[name].clone() + \
                                (1-tau)*target_critic_state_dict_task3[name].clone()
        ...
        self.target_critic_task3.load_state_dict(critic_state_dict_task3)
